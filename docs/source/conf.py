...
# -*- coding: utf-8 -*-
#
# pyvtkjs documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pyvtkjs', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pyvtkjs.tex', 'pyvtkjs Documentation',
     'renefritze', 'manual'),
]
